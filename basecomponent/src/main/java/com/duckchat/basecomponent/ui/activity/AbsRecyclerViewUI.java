package com.duckchat.basecomponent.ui.activity;
...
import com.duckchat.basecomponent.comn.ItemDecoration.BaseItemDecoration;
import com.duckchat.basecomponent.comn.callback.HttpCallBack;
import com.duckchat.basecomponent.core.HttpFrame.BaseHttp;
import com.duckchat.basecomponent.widget.xlistview.XListViewFooter;
import com.duckchat.basecomponent.widget.xrecyclerview.BaseRecyclerAdapter;
import com.duckchat.basecomponent.widget.xrecyclerview.RecyclerViewHolder;
import com.duckchat.basecomponent.widget.xrefresh.XSwipeRefreshLayout;
...
public abstract class AbsRecyclerViewUI<T extends Model> extends BaseUI implements SwipeRefreshLayout.OnRefreshListener {
    ...
    protected void onCreateBase() {
        ...
        //下拉刷新、加载更多
        mSwipeRefreshLayout = (XSwipeRefreshLayout) findViewById(R.id.swipeRefresh);
        ...
        mAdapter = new MyAdapter(this, new ArrayList<T>());
    ...
    public XListViewFooter createFooterView() {
        XListViewFooter mFooterView = new XListViewFooter(this);
    ...
    protected int setItemViewType(int position) {
        return BaseRecyclerAdapter.TYPE_NORMAL;
    }
     ...
     * 绑定脚布局文件关联
     */
    protected int setFooterLayoutId() {
        return 0;
    }
    ...
    protected void setSpanSize(RecyclerView recyclerView) {
        ...
        if (manager instanceof GridLayoutManager) {
            ...
            gridManager.setSpanSizeLookup(new GridLayoutManager.SpanSizeLookup() {
                @Override
                /** 这个方法的返回值决定了我们每个position上的item占据的单元格个数 */ public int getSpanSize(int position) {
                    ...
                    if (mAdapter.getItemViewType(position) == 0xff18 || mAdapter.getItemViewType(position) == 0xff19) {
                        return 2;
                    } else if (mAdapter.getItemViewType(position) == mAdapter.TYPE_NORMAL) {
                        return 1;
                    } else {

package com.duckchat.basecomponent.core.HttpFrame;
...
import com.duckchat.basecomponent.core.HttpFrame.api.ApiRequest;
import com.duckchat.basecomponent.core.HttpFrame.config.BaseHttpConfig;
...
public class BaseHttp {
    ...
    public void uploadFile(String path, List<HashMap<String, Object>> fileList, HttpCallBack callBack) {
        uploadFile(null, path, fileList, callBack);
    }
     ...
     * @param callBack 回调方法
     **/
    public <T extends Activity> void uploadFile(T activity, String path, List<HashMap<String, Object>> fileList, HttpCallBack callBack) {
        repeatHttpInterceptor(path, activity, callBack);
        callBack.setPort(path);//接口编号
        callBack.setRequestType(HttpCallBack.REQUEST_WRITE);
    ...
    class OkhttpCallback implements Callback {
        ...
        public void onResponse(Call call, Response response) throws IOException {
            if (response.isSuccessful()) {
                ...
                } else if (HttpCallBack.RESPONSE_BYTEARRAY == httpCallBack.getResponseType()) {
